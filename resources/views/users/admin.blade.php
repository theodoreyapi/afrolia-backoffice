@extends('layouts.master', ['title' => 'Administrateurs'])
            ...
            <div class="modal fade" id="addExampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
                    <div class="modal-content radius-16 bg-base">
                        <div
                            class="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0 bg-primary text-white">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-6 mb-20">
                                                                    ...
                                                                    <input type="text" name="firstname" required
                                                                        ...
                                                                        placeholder="Entrer son nom" value="{{ $item->name }}">
                                                                </div>
                                                                <div class="col-6 mb-20">
                                                                    <label for="name"
                                                                        class="form-label fw-semibold text-primary-light text-sm mb-8">
                                                                    ...
                                                                    <input type="text" name="lastname" required
                                                                        class="form-control radius-8" id="name"
                                                                        placeholder="Entrer son prénom" value="{{ $item->last_name }}">
                                                                </div>
                                                                <div class="col-6 mb-20">
                                                                    <label for="name"
                                                                        class="form-label fw-semibold text-primary-light text-sm mb-8">
                                                                    ...
                                                                    <input type="email" name="email" required
                                                                        class="form-control radius-8" id="name"
                                                                        placeholder="Entrer son e-mail" value="{{ $item->email }}">
                                                                </div>
                                                                <div class="col-6 mb-20">
                                                                    <label for="name"
                                                                        class="form-label fw-semibold text-primary-light text-sm mb-8">
                                                                    ...
                                                                    <input type="text" name="phone"
                                                                        class="form-control radius-8" id="name"
                                                                        placeholder="Entrer son numéro de Téléphone" value="{{ $item->phone }}">
                                                                </div>
                                                                <div class="col-6 mb-20">
                                                                    <label for="country"
                                                                        class="form-label fw-semibold text-primary-light text-sm mb-8">Profil
                                                                    ...
                                                                    <select required name="profil" class="form-control radius-8 form-select"
                                                                        id="country">
                                                                        <option value="{{ $item->role }}">Sélectionne</option>
                                                                        <option value="SUPERADMIN">SUPERADMIN</option>
                                                                        <option value="ADMIN">ADMIN</option>
                                                                        <option value="PHARMACIEN">PHARMACIEN</option>
                                                                        <option value="GESTIONNAIRE">GESTIONNAIRE</option>
