                    ...
                    <table class="table bordered-table mb-0" id="dataTable" data-page-length='10'>
                        ...
                        <tbody>
                            @foreach ($users as $item)
                                @php
                                    $cumulReservations = App\Models\Reservations::where(
                                        'id_coiffeur',
                                        $item->id_user_app,
                                    )
                                        ->where('statut', 'terminee')
                                        ->count();
                                    $cumulDepenses = App\Models\Reservations::where(
                                        'id_coiffeur',
                                        $item->id_user_app,
                                    )->sum('prix_service');
                                @endphp
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img height="80" width="80" src="{{ url($item->photo) ? $item->photo : url($item->photo) }}"
                                    ...
                                    <td>
                                        {{ $cumulReservations }} Réservations
                                    </td>
                                    <td>
                                        <strong style="color: green">{{ $cumulDepenses }} FCFA</strong>
                                    </td>
                                    <td>
                                        <span
                                                    ...
                                                    <div class="modal-body p-24">
                                                        <form action="{{ route('users.store') }}" role="form"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 mb-20">
                                                                    <label for="name"
                                                                        class="form-label fw-semibold text-primary-light text-sm mb-8">Adresse
                                                                    </label>
