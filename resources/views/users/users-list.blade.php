    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Liste des clients</li>
            </ul>
        </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
                    <div class="modal-content radius-16 bg-base">
                        <div class="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0"
                            ...
                            <h1 class="modal-title fs-5 text-white" id="exampleModalLabel">Ajouter un nouveau client
                            </h1>
                        ...
                        <tbody>
                            @foreach ($users as $item)
                                <tr>
                                    ...
                                    <td>
                                        <strong
                                            style="color: green">{{ number_format($item->total_depenses ?? 0, 0, ',', ' ') }}
                                            FCFA</strong>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('users.show', $item->id_user_app) }}" title="Voir détails"
                                        ...
                                        <div class="modal fade" id="reactivateModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog modal-dialog-centered">
                                                <div class="modal-content radius-16 bg-base">
                                                    ...
                                                    <div class="modal-body p-24">
                                                        <form action="{{ route('users.reactivate', $item->id_user_app) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="row">
                                                                <p>
                                        ...
                                        <div class="modal fade" id="suspendModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog modal-dialog-centered">
                                                <div class="modal-content radius-16 bg-base">
                                                    ...
                                                    <div class="modal-body p-24">
                                                        <form action="{{ route('users.suspend', $item->id_user_app) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="row">
                                                                <div class="mb-20">
                                                                    <label class="form-label fw-semibold">Raison de la
                                                                        suspension <strong
                                                                            style="color: red">*</strong></label>
                                                                    <textarea name="raison" required class="form-control radius-8" rows="3"
                                                                        placeholder="Ex: Comportement inapproprié"></textarea>
                                                                </div>
                                                                <p>Êtes-vous sûr de vouloir suspendre ce client ?</p>
                                                                <div
                                                                    class="d-flex align-items-center justify-content-center gap-3 mt-24">
                                                                    <button type="reset" data-bs-dismiss="modal"
                                                                        class="border border-danger-600 ...">Annuler</button>
                                                                    <button type="submit"
                                                                        class="btn btn-warning ...">Oui, Suspendre</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
