@extends('layouts.master', ['title' => 'Politique et confidentialites'])
...
@section('content')
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Politique de confidentialité</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Politique de confidentialité et de protection des données personnelles</li>
            </ul>
        </div>
        ...
        <div class="card basic-data-table radius-12 overflow-hidden">
            <form action="{{ route('termes.storeOrPolitique') }}" method="post">
                @csrf
                <textarea required class="summernote" name="notice">
                {{ old('politicy', $termes->politicy ?? '') }}
                </textarea>
