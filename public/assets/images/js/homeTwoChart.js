  ...
  createChart('new-user-chart', '#EA580C');
  ...
  createChartTwo('revenue-chart', '#EA580C');
  ...
  // ================================ Earning Statistics bar chart Start ================================
    var options = {
      ...
      fill: {
          type: 'gradient',
          colors: ['#EA580C'], // Set the starting color (top color) here
          gradient: {
              shade: 'light', // Gradient shading type
              type: 'vertical',  // Gradient direction (vertical)
              shadeIntensity: 0.5, // Intensity of the gradient shading
              gradientToColors: ['#EA580C'], // Bottom gradient color (with transparency)
              inverseColors: false, // Do not invert colors
