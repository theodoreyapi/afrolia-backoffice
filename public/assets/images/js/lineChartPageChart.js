  ...
  createChartTwo('zoomAbleLineChart', '#EA580C');
  // =========================== Zoom able Line Chart End ===============================
  ...
  // =========================== Line Chart With Data labels Start ===============================
    var options = {
        ...
        colors: ['#EA580C'],  // Set the color of the series
        dataLabels: {
          enabled: true
        },
        stroke: {
  ...
  function createLineChart(chartId, chartColor) {
    var options = {
      ...
      colors: ['#EA580C', '#FF9F29'],  // Set the color of the series
      dataLabels: {
          enabled: false
      },
      stroke: {
  ...
  createLineChart('doubleLineChart', '#EA580C');
