  ...
  createChart('new-user-chart', '#571C87');
  ...
  createChartTwo('revenue-chart', '#571C87');
  ...
  // ================================ Earning Statistics bar chart Start ================================
    var options = {
      ...
      fill: {
          type: 'gradient',
          colors: ['#571C87'], // Set the starting color (top color) here
          gradient: {
              shade: 'light', // Gradient shading type
              type: 'vertical',  // Gradient direction (vertical)
              shadeIntensity: 0.5, // Intensity of the gradient shading
              gradientToColors: ['#571C87'], // Bottom gradient color (with transparency)
              inverseColors: false, // Do not invert colors
