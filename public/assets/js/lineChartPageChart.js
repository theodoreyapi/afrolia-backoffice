  ...
  createChartTwo('zoomAbleLineChart', '#571C87');
  // =========================== Zoom able Line Chart End ===============================
  ...
  // =========================== Line Chart With Data labels Start ===============================
    var options = {
        ...
        colors: ['#571C87'],  // Set the color of the series
        dataLabels: {
          enabled: true
        },
        stroke: {
  ...
  function createLineChart(chartId, chartColor) {
    var options = {
      ...
      colors: ['#571C87', '#FF9F29'],  // Set the color of the series
      dataLabels: {
          enabled: false
      },
      stroke: {
  ...
  createLineChart('doubleLineChart', '#571C87');
